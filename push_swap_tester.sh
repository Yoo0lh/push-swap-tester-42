...
yellow=`tput setaf 3`
idont=`tput setaf 5`
for i in {1..40}; do  echo "$yellow---------- TEST $i ----------------------------------------";
...
echo "\n"
echo "${red}NOTE 1: ${yellow}if you have ${red}KO ${yellow}you can check (./test_file) to see the example that we use to check you program"
...
echo "${red}N     : ${yellow}nmbres of opreation by your program"